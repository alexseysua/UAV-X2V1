...
public:
	...
	*/
	...
	bool UpdateStates(double *u_ptr, double *x_ptr, double *fc_ptr, double *p_ptr, double *c_ptr);
	bool UpdateStates(double *u_ptr, double *dx_ptr, double *x_ptr, double *fc_ptr, double *p_ptr, double *c_ptr);
